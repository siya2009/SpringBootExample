package com.singh.springboot.web.controller;
...
//	
	 ...
	 * String password ) {
	 * 
	 * boolean isValidUser = service.validateUser(name, password); if(!isValidUser)
	 * { model.put("errorMessage", "Invalid Credentials"); return "/login"; }
	 * model.put("name", name); model.put("password", password);
	 * //System.out.println("name is ====>"+name); return "welcome"; }
	 */
}
